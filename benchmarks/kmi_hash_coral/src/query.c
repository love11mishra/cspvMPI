 ...
 */
//void _KMI_query_db_check_stage0(KMI_db_t db)
void _KMI_query_db_check_stage0(KMI_db_t db)
{
    int flag;
    MPI_Status st;
...
int kmi_set_all_deleted(KMI_table_t tb)
{
    int rc = 0;
...
int kmi_set_deleted_flag(KMI_table_t tb, int rank)
{
    int myid = tb->myid;
    int numprocs = tb->numprocs;
...
void _KMI_query_db_check_stage3(KMI_db_t db)
{
    int flag;
    int myid;
...
void _KMI_query_db_check_stage4(KMI_db_t db)
{
...
void _KMI_query_db_check_stage5(KMI_db_t db)
{
...
int _KMI_query_db_prefix_delete(KMI_db_t db, char *str, long str_len,
                                       KMI_error_tolerance_t etlr,
                                       KMI_hash_table_record_t **list,
                                       int *list_len)
{
...
int _KMI_query_db_prefix(KMI_db_t db, char *str, long str_len,
                                KMI_error_tolerance_t etlr,
                                KMI_hash_table_record_t **list, int *list_len)
{
