...
#define MPI_Waitall(count, array_of_requests, array_of_statuses) CR_MPI_Waitall(count, array_of_requests, array_of_statuses, __LINE__);
...
#define MPI_Gather(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, root, comm) CR_MPI_Gather(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, root, comm, __LINE__);
...
EXTERN int CR_MPI_Waitall(int count, MPI_Request array_of_requests[], MPI_Status array_of_statuses[], int line) __SKIP;
