...
class Search {
 public:
  Search(int num_procs, const string& program, int max_iterations);
  virtual ~Search();
...
class BoundedDepthFirstSearch : public Search {
 public:
  explicit BoundedDepthFirstSearch(int num_procs, const string& program,
				   int max_iterations,
				   int max_depth);
...
class RandomInputSearch : public Search {
 public:
  RandomInputSearch(int num_procs, const string& program, int max_iterations);
...
class RandomSearch : public Search {
 public:
  RandomSearch(int num_procs, const string& program, int max_iterations);
...
class UniformRandomSearch : public Search {
 public:
  UniformRandomSearch(int num_procs, const string& program, int max_iterations, size_t max_depth);
...
class HybridSearch : public Search {
 public:
  HybridSearch(int num_procs, const string& program, int max_iterations, int step_size);
...
class CfgBaselineSearch : public Search {
 public:
  CfgBaselineSearch(int num_procs, const string& program, int max_iterations);
...
class CfgHeuristicSearch : public Search {
 public:
  CfgHeuristicSearch(int num_procs, const string& program, int max_iterations);
