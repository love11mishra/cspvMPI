...
////////////////////////////////////////////////////////////////////////
  ...
  Search::Search(int num_procs, const string& program, int max_iterations)
  : num_procs_(num_procs), program_(program), max_iters_(max_iterations), num_iters_(0) {
...
void Search::LaunchProgram(const vector<value_t>& inputs) {
  ...
  */
  char command[512] = {0};
  sprintf(command, "mpirun -n %d %s", num_procs_, program_.c_str());
  printf("%s\n", command);
  system(command);
}
...
void Search::RunProgram(const vector<value_t>& inputs, SymbolicExecution* ex) {
 ...
 // Rename the trace file of current iteration @lavleshm
  string allFiles = "MpiTrace0.txt";
  for(int procid = 1; procid < num_procs_ ; procid++){
  	allFiles += " MpiTrace" + std::to_string(procid) + ".txt";
  }

  string traceFileName = "MpiTrace_"+ std::to_string(num_iters_) + ".txt";
  string command1 = "cat " + allFiles + " > "+ traceFileName;
  string command2 = "rm " + allFiles;
...
(int num_procs, const string& program, int max_iterations, int max_depth)
  : Search(num_procs, program, max_iterations), max_depth_(max_depth) { }
...
////////////////////////////////////////////////////////////////////////
  ...
  RandomInputSearch::RandomInputSearch(int num_procs, const string& program, int max_iterations)
    : Search(num_procs, program, max_iterations) { }
...
////////////////////////////////////////////////////////////////////////
  ...
  RandomSearch::RandomSearch(int num_procs, const string& program, int max_iterations)
    : Search(num_procs, program, max_iterations) { }
...
////////////////////////////////////////////////////////////////////////
  ...
  UniformRandomSearch::UniformRandomSearch(int num_procs, const string& program,
					 int max_iterations,
					 size_t max_depth)
    : Search(num_procs, program, max_iterations), max_depth_(max_depth) { }
...
////////////////////////////////////////////////////////////////////////
  ...
  HybridSearch::HybridSearch(int num_procs, const string& program, int max_iterations, int step_size)
    : Search(num_procs, program, max_iterations), step_size_(step_size) { }
...
////////////////////////////////////////////////////////////////////////
  ...
  CfgBaselineSearch::CfgBaselineSearch(int num_procs, const string& program, int max_iterations)
    : Search(num_procs, program, max_iterations) { }
...
(int num_procs, const string& program, int max_iterations)
  : Search(num_procs, program, max_iterations),
