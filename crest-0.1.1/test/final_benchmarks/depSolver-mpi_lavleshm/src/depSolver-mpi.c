...
unsigned int          nodeMin, nodeMax, localNodes, localSize;
int          pointMin, pointMax, localPoints;
unsigned int          forceMin, forceMax, localForcePoints;
unsigned int          forceElemMin, forceElemMax, localForceElems;
int          nprocs, proc;
const int    master = 0;
