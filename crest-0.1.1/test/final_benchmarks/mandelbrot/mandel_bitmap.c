...
#include<crest.h>
//#include <mpi.h>
#define		X_RESN	10 //100   /* x resolution */
#define		Y_RESN	10 //50   /* y resolution */
#define     M_MAX   1000//1048576       /* Max iterations for Mandelbrot */
// BITMAP header
#pragma pack(push, 1)
typedef struct
{
